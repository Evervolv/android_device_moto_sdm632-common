...
$(call inherit-product, vendor/moto/sdm632-common/sdm632-common-vendor.mk)
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/privapp-permissions-google.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/privapp-permissions-google.xml \
